// screens/btts_screen.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../services/api_service.dart';
import '../models/btts_model.dart';

class BttsScreen extends StatefulWidget {
  const BttsScreen({super.key});

  @override
  State<BttsScreen> createState() => _BttsScreenState();
}

class _BttsScreenState extends State<BttsScreen> {
  final ApiService _apiService = ApiService();
  BTTSAccumulator? _accumulator;
  ...
  Future<void> _fetchBttsData() async {
    setState(() {
      _isLoading = true;
      _errorMessage = '';
    });
    ...
    try {
      ...
      setState(() {
        _errorMessage = 'Failed to load BTTS predictions';
        _isLoading = false;
      });
      print('Error: $e');
    }
...
Widget _buildAccumulatorCard(BTTSAccumulator accumulator) {
  return Card(
    elevation: 4,
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'This analytical approach focuses on matches where both teams have strong offensive capabilities and defensive vulnerabilities. We analyze team form, attacking statistics, defensive records, and head-to-head data to identify games with a high probability of both teams finding the back of the net.',
            style: TextStyle(
              fontSize: 14,
  ...
  Widget _buildMatchItem(BttsMatch match) {
  return Container(
